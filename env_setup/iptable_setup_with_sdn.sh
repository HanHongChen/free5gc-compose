...
sudo iptables -I FORWARD 1 -s ${UPF1_IP}/32 -d 192.168.58.0/24 -j ACCEPT
sudo iptables -I FORWARD 1 -s ${UPF1_IP}/32 -d 192.168.59.0/24 -j DROP
sudo iptables -I FORWARD 1 -s ${UPF2_IP}/32 -d 192.168.59.0/24 -j ACCEPT
sudo iptables -I FORWARD 1 -s ${UPF2_IP}/32 -d 192.168.58.0/24 -j DROP

sudo iptables -I FORWARD 3 -m state --state ESTABLISHED,RELATED -j ACCEPT

sudo iptables -I FORWARD 4 -s ${UE1_IP}/32 -d 192.168.58.20/32 -j DROP
sudo iptables -I FORWARD 4 -s ${UE1_IP}/32 -d 192.168.59.20/32 -j DROP
sudo iptables -I FORWARD 4 -s ${UE2_IP}/32 -d 192.168.58.20/32 -j DROP
sudo iptables -I FORWARD 4 -s ${UE2_IP}/32 -d 192.168.59.20/32 -j DROP
